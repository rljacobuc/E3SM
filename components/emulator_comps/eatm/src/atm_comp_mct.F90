...
!JW          a2x_a%rattr(index_a2x_Sa_topo,n)    = 0._r8
          ...
          a2x_a%rattr(index_a2x_Sa_ptem,n)    = thbot(i,j)
          a2x_a%rattr(index_a2x_Sa_shum,n)    = qbot(i,j)
          a2x_a%rattr(index_a2x_Sa_dens,n)    = rho(i,j)
          a2x_a%rattr(index_a2x_Sa_pbot,n)    = pbot(i,j)
          a2x_a%rattr(index_a2x_Sa_pslv,n)    = psl(i,j)
          a2x_a%rattr(index_a2x_Faxa_lwdn,n)  = flwds(i,j)
          ...
          a2x_a%rattr(index_a2x_Faxa_swndr,n) = soll(i,j)
          a2x_a%rattr(index_a2x_Faxa_swvdr,n) = sols(i,j)
          a2x_a%rattr(index_a2x_Faxa_swndf,n) = solld(i,j)
          a2x_a%rattr(index_a2x_Faxa_swvdf,n) = solsd(i,j)
          a2x_a%rattr(index_a2x_Faxa_swnet,n) = netsw(i,j)
       enddo
    enddo
